...
def aplicarValidacao(arquivo):
    ...
    ws = wb.get_sheet_by_name('Fluxo_Caixa')

    # Entry Type
    et_enum = '=Categorias!$A$3:$A$5'
    et_range = 'L5:L1000'
    dataval_list(ws, et_enum, et_range)

    # Discussion Priority
    dp_enum = '=Categorias!$B$3:$B$5'
    dp_range = 'M5:M1000'
    dataval_list(ws, dp_enum, dp_range)

    # Review Significance
    rs_enum = '=Categorias!$C$3:$C$5'
    rs_range = 'N5:N1000'
    dataval_list(ws, rs_enum, rs_range)

    # Review Charge
    rc_enum = "=Categorias!$D$3:$D$16"
    rc_range = "O5:O1000"
    dataval_list(ws, rc_enum, rc_range)

    # Related Document
    rd_enum = '=Categorias!$E$3:$E$48'
    rd_range = 'P5:P1000'
